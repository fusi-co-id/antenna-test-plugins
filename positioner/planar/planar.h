...
#ifndef PLANARPOSITIONER_H
#define PLANARPOSITIONER_H
...
class PlanarPositioner : public IPositionerPlugin
{
    
public:
    PlanarPositioner();
    virtual ~PlanarPositioner();
    ...
    SocketInstrument *m_socketInstrument;
